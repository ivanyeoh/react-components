...
ReactDOM.render(React.createElement(React.Fragment, null, React.createElement(_Nav.default, {
  ...
  description: React.createElement("p", null, "One stop solution provider of interior designs & built services for all business entity and residence"),
  cssBackgroundImage: "url('/img/interior-designs/0.jpg')"
}), React.createElement(_Slideshow.default.Slide, {
  title: "Welcome to GoodWinds2",
  description: React.createElement("p", null, "We are interior design & build company that provide a comprehensive services from interior design planning, architecture, implementation & construction management, and consultancy services to literally almost all sectors that you can imagine which mentioned below"),
