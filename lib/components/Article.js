...
const RightFigureArticle = ({
  ...
  figure,
  figcaption
}) => _react.default.createElement(_react.Fragment, null, _react.default.createElement("h2", null, title), _react.default.createElement("figure", null, children, _react.default.createElement("figcaption", null, figcaption)), children);
...
const SplitArticle = ({
  ...
  className: "left"
}, _react.default.createElement("h2", null, title), children), _react.default.createElement("div", {
  className: "right"
}, figure));
